// this an JS converted version of this code https://go.dev/play/p/7ltvaj8lhRl
...
export function createRandomnessFactorAndData(seed = Math.floor(Math.random() * 1000000)) {
